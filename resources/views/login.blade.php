...
<main class="form-signin w-100 m-auto">
  <form action="" method="POST">
    ...
    @endif
    <h1 class="h3 mb-3 fw-normal">Login <div> <span class="text-danger fw-bold">Lara</span>bank</div></h1>
    ...
    <button class="btn btn-outline-danger w-50 py-2 my-4" type="submit">Sign in</button>
